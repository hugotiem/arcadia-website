...
export const espritSections: EspritSection[] = [
  {
    id: "terroir",
  ...
  {
    id: "detente",
    title: "L'esprit Détente & Bien-Être",
    description: "Imaginez-vous sur le pont, les vagues caressant doucement la coque, le soleil réchauffant votre peau. Profitez de moments de relaxation, de massages en mer ou de séances de yoga pour harmoniser votre corps et votre esprit. Chaque instant est pensé pour vous offrir une semaine totale entre deux croisières et partenaires inoubliables.",
    image: "/wellness.jpg"
  },
  {
  ...
  {
    id: "sur-mesure",
    title: "L'esprit Sur-Mesure",
    description: "Vivez l'exclusivité à chaque instant. À bord de notre voilier, tout est possible : un dîner romantique sous les étoiles, une excursion privée dans les îles ou une journée entre amis. Notre équipage est là pour parler, de répondre à chaque désir, pour créer une expérience qui vous ressemble. La clé, c'est la plus belle définition : votre bonheur, sur mesure.",
    image: "/custom.jpg"
  },
  {
    id: "equipage",
    title: "L'esprit de l'équipage",
    description: "L'équipage incarne l'essence même de notre voilier : des marins fiers, solides et ingénieux, dévoués à une expérience de voyage d'exception. Chaque membre est guidé par un respect mutuel et une complicité discrète, où le professionnalisme et l'art de se surpasser à bord, nous répondons à vos désirs avec finesse, créant une ambiance à la fois élégante et authentique, où chaque moment devient un échange précieux.",
    image: "/crew.jpg"
  }
] 